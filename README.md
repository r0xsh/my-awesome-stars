...
- [donjajo/als-led-backlight](https://github.com/donjajo/als-led-backlight) - Auto control of keyboard and LCD backlight throught Ambient Light Sensor
...
- [ldufr/search](https://github.com/ldufr/search) - GUI built on ripgrep for recursive file content searching.
...
- [HappySeaFox/sail](https://github.com/HappySeaFox/sail) - ⛵The missing fast imaging library for humans (not for machines).
- [phoboslab/qoi](https://github.com/phoboslab/qoi) - The “Quite OK Image Format” for fast, lossless image compression
- [dbro/csvquote](https://github.com/dbro/csvquote) - Enables common unix utilities like cut, awk, wc, head to work correctly with csv data containing delimiters and newlines
- [lvgl/lv_esp_idf](https://github.com/lvgl/lv_esp_idf) - LVGL ported to ESP32 including various display and touchpad drivers
...
- [guiodic/material-decoration](https://github.com/guiodic/material-decoration) - Material-ish window decoration theme for KWin, with Locally Integrated Menu and Menu Search, based on zzag's original design. LIM introduction by Zren. Ported to QT6 by nicman23, maintained and improv
...
- [soufianekhiat/ImAnim](https://github.com/soufianekhiat/ImAnim) - Animation Engine for Dear ImGui
...
- [jgilchrist/gbemu](https://github.com/jgilchrist/gbemu) - A Gameboy emulator
...
- [ArangoDB-Community/arangox](https://github.com/ArangoDB-Community/arangox) - Elixir driver for ArangoDB 3.12 on DBConnection: HTTP via Mint, pooling, AQL, stream transactions, cursors, and a resource API over ArangoDB's HTTP surface. VelocyStream and active failover remain for
...
- [PVRLabs/statlite](https://github.com/PVRLabs/statlite) - A tiny self-hosted metrics dashboard for small servers.  Spring Boot and Quarkus monitoring with SQLite, simple charts, and no Prometheus/Grafana stack required.
...
- [r7sqtr/spectra.nvim](https://github.com/r7sqtr/spectra.nvim) - NvChad-style colorscheme picker for Neovim with color palette preview.
- [shushtain/incselect.nvim](https://github.com/shushtain/incselect.nvim) - incremental selection with tree-sitter
- [shushtain/spectrolite.nvim](https://github.com/shushtain/spectrolite.nvim) - convert and highlight colors
...
- [oskarrrrrrr/symbols.nvim](https://github.com/oskarrrrrrr/symbols.nvim) - Code navigation sidebar for Neovim.
...
- [steviebez/Nvim-Config-Guide](https://github.com/steviebez/Nvim-Config-Guide) - Modular Neovim configuration reference detailing structure, plugin lazy-loading strategies, keymap definitions, and custom Autocommands (hooks). Note: Generated by Claude
- [AnAxeCalledNegus/Project-Symphony](https://github.com/AnAxeCalledNegus/Project-Symphony) - 
- [MobilityData/GOFS](https://github.com/MobilityData/GOFS) - The General On-Demand Format Specification (GOFS).
...
- [ascodesoftware/dockering](https://github.com/ascodesoftware/dockering) - 🐘Just another WordPress site made with Docker and docker-compose!
...
- [dbt-labs/dbt-charts](https://github.com/dbt-labs/dbt-charts) - 
...
- [arman-bd/httpmorph](https://github.com/arman-bd/httpmorph) - httpmorph is a drop-in replacement for Python's requests library that uses a custom C implementation with BoringSSL instead of Python's standard HTTP stack.
...
- [ALD-Lab/SURD](https://github.com/ALD-Lab/SURD) - 
...
- [Paligo/xee-php](https://github.com/Paligo/xee-php) - PHP bindings for Xee XML tools
...
- [SteamTracking/Protobufs](https://github.com/SteamTracking/Protobufs) - 👑 Automatically tracked Steam, CS2, Dota 2, Deadlock, TF2 protobufs.
...
- [wmxscott/bash-script-generator](https://github.com/wmxscott/bash-script-generator) - Generates a Bash Script Template that handles Arguments and Flags Cleanly
...
- [jasonepage/Seal](https://github.com/jasonepage/Seal) - 
...
- [glncy/v0-expo-up-server](https://github.com/glncy/v0-expo-up-server) - 
...
- [apple-aiml-research/VideoFlashingReduction](https://github.com/apple-aiml-research/VideoFlashingReduction) - 
